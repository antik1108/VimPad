...
<table width="100%">
	<tr>
		<td align="left" width="33.33%" style="padding: 6px;">
			<a href="apps/web/public/screenshots/config.jpg"><img src="apps/web/public/screenshots/config.jpg" alt="screenshot-1" width="100%" /></a>
		</td>
		<td align="left" width="33.33%" style="padding: 6px;">
			<a href="apps/web/public/screenshots/history.jpg"><img src="apps/web/public/screenshots/history.jpg" alt="screenshot-2" width="100%" /></a>
		</td>
		<td align="left" width="33.33%" style="padding: 6px;">
			<a href="apps/web/public/screenshots/splash.jpg"><img src="apps/web/public/screenshots/splash.jpg" alt="screenshot-3" width="100%" /></a>
		</td>
	</tr>
	<tr>
		<td align="left" width="33.33%" style="padding: 6px;">
			<a href="apps/web/public/screenshots/editor.jpg"><img src="apps/web/public/screenshots/editor.jpg" alt="screenshot-4" width="100%" /></a>
		</td>
		<td align="left" width="33.33%" style="padding: 6px;">
			<a href="apps/web/public/screenshots/login.jpg"><img src="apps/web/public/screenshots/login.jpg" alt="screenshot-5" width="100%" /></a>
		</td>
		<td align="left" width="33.33%" style="padding: 6px;">
			<a href="apps/web/public/screenshots/notes.jpg"><img src="apps/web/public/screenshots/notes.jpg" alt="screenshot-6" width="100%" /></a>
		</td>
	</tr>
</table>
